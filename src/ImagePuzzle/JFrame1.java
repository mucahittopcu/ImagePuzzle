...
public class JFrame1 extends javax.swing.JFrame {
    ...
    public void yerDegistirmeIslemi(int butonId) {
        ...
        if (seciliMi == true && swapTutulan == butonId) {
            ...
            butonDizisi[swapTutulan].setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        } else {
            //jButton1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(222, 37, 37)));
            butonDizisi[butonId].setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(222, 37, 37), 5));
            System.out.println("seçili durumu:" + seciliMi);
